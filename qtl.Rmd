...
Permasalah mengenai pemuliaan tanaman secara konvensional telah mendapat titik terang dengan ditemukannya markah/penanda molekuler. Suatu pendanda (marker) memuat informasi suatu sifat dari tanaman yang berasosiasi dengan susunan genotip tertentu. Marker tersebut dapat dijadikan sebagai informasi untuk mengidentifikasi letak gen yang signifikan mempengaruhi suatu sifat tanaman, dengan menggunakan metode *Quantitative Trait Locus* (QTL). Adapun beberapa marker yang cukup umum dan sudah banyak 
